...
/**
 * Enterprise-grade LaTeX & Math formatting service.
 * Handles normalization, delimiter balancing, safe KaTeX rendering, and multi-format exports.
 */
export class LatexService {
   ...
   */
  public static sanitize(latex: string): string {
    if (!latex) return '';
    let s = latex.trim();
   ...
   */
  public static renderSafe(latex: string, colorHex?: string): string {
    const sanitized = LatexService.sanitize(latex);
   ...
   */
  public static exportOverleaf(equation: ColorizedEquation, palette: PaletteType): string {
...
`;
   ...
   */
  public static exportMarkdown(equation: ColorizedEquation): string {
...
export const normalizeLatexString = LatexService.normalize;
export const sanitizeLatexChunk = LatexService.sanitize;
export const renderLatexSafe = LatexService.renderSafe;
export const exportToOverleafLatex = LatexService.exportOverleaf;
export const exportToMarkdown = LatexService.exportMarkdown;
